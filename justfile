...
PLAN_TEST_FILES := "-filter=tests/plan_validate_project.tftest.hcl -filter=tests/plan_validate_ip_access_list.tftest.hcl -filter=tests/plan_validate_reference_mode.tftest.hcl -filter=tests/plan_validate_log_integration.tftest.hcl -filter=tests/plan_validate_backup_compliance_policy.tftest.hcl"
