...
**Validation rules:**
1. Type in [allowed-types.txt](../tools/changelog/allowed-types.txt), prefix in [allowed-prefixes.txt](../tools/changelog/allowed-prefixes.txt).
...
- [`tools/changelog/allowed-types.txt`](../tools/changelog/allowed-types.txt) - Valid types.
- [`tools/changelog/allowed-prefixes.txt`](../tools/changelog/allowed-prefixes.txt) - Valid prefixes.
- [`tools/changelog/check-changelog-entry-file/main.go`](../tools/changelog/check-changelog-entry-file/main.go) - Validation script.
